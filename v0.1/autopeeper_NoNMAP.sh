#!/bin/bash
# AutoPeeper without nmap scan
#
# This Script Takes an input nmap scan and parses it out for http, https & unknown services
...
echo
echo 'Getting NMAP Output'
echo
# Prompts for user input of  input file name and output name
echo -n "Please enter the file name of the .gnmap output file and press [ENTER]: "
read output_nmap
...
echo "Outputting Results to Default Browser"
